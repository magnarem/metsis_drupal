...
[![Quality](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?label=Quality&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
[![ESLint](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?job=ESLint&label=ESLint&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
[![Prettier](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?job=Prettier%20Check&label=Prettier&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
[![PHPStan](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?job=PHPStan&label=PHPStan&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
[![PHPCS](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?job=PHPCS&label=PHPCS&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
[![PHPUnit](https://img.shields.io/github/actions/workflow/status/metno/metsis_drupal/quality.yml?job=PHPUnit&label=PHPUnit&style=flat-square)](https://github.com/metno/metsis_drupal/actions/workflows/quality.yml)
